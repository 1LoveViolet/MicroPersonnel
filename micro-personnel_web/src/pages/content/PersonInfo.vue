  ...
  mounted() {
    ...
    this.axios.get('eduinfo/get/' + userid, {
      ...
      .then((response) => {
        ...
        this.eduinfoData.push(response.data.data)
      })
    ...
    this.axios.get('certificate/get/' + userid, {
      ...
      .then((response) => {
        let { data, status } = response
        this.certificateData.push(response.data.data)
      })
      .catch(function (error) {
        console.log(error);
      })
    ...
    this.axios.get('contact/get/' + userid, {
      ...
      .then((response) => {
        let { data, status } = response
        this.contactData.push(response.data.data)
      })
      .catch(function (error) {
        console.log(error);
      })
    ...
    this.axios.get('workexp/get/' + userid, {
      ...
      .then((response) => {
        let { data, status } = response
        this.workData.push(response.data.data)
      })
      .catch(function (error) {
        console.log(error);
      })
    ...
    this.axios.get('proexp/get/' + userid, {
      ...
      .then((response) => {
        let { data, status } = response
        this.proexpData.push(response.data.data)
      })
      .catch(function (error) {
        console.log(error);
      })
    ...
    this.axios.get('skillList/get/' + userid, {
      ...
      .then((response) => {
        let { data, status } = response
        this.skillListData.push(response.data.data)
      })
      .catch(function (error) {
        console.log(error);
      })
